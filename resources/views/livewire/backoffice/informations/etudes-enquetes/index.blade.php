    ...
    <div class="flex flex-col gap-3 bg-gray-50 px-5 py-4 text-center sm:flex-row sm:items-center sm:justify-between sm:gap-0 sm:text-left dark:bg-gray-700/50">
        ...
        <div
            ...
            <a href="{{ route('backoffice.etudes-enquetes.create') }}"
                ...
                <span>Ajouter une étude/enquête</span>
            </a>
        </div>
    </div>
    ...
    <div class="grow rounded-lg bg-white p-4 text-sm shadow-xs shadow-gray-300/25 dark:bg-gray-900 dark:shadow-none">
        <div class="min-w-full overflow-x-auto rounded-sm">
            <table class="min-w-full align-middle text-sm whitespace-nowrap">
                ...
                <tbody>
                    @forelse ($etudes_enquetes as $el)
                        <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                            <td class="p-3">
                                <p class="font-medium">{{ $el->title }}</p>
                            </td>
                            <td class="p-3">
                                <p class="font-medium">{{ $el->short_description }}</p>
                            </td>
                            <td class="p-3">
                                <p class="font-medium">{{ $el->publication_date->format("d M Y") }}</p>
                            </td>
                            <td class="p-3">
                                <p class="font-medium">{{ $el->categorie?->name }}</p>
                            </td>
                            <td class="p-3">
                                @if ($el->is_online)
                                    <div
                            ...
                            <td class="py-3 pl-3 text-right">
                                <div class="inline-flex items-center gap-1">
                                    <a href="{{ route('backoffice.etudes-enquetes.edit', $el->id) }}"
                                    ...
                                    <button type="button" x-on:click="open = true"
                                        ...
                                        wire:click="selectEtudeEnquete({{ $el }})">
                                        Supprimer
                                    </button>
                                </div>
                            </td>
    ...
    <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="flex grow gap-5 px-5 py-7">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Êtes-vous sûr de vouloir supprimer cette étude/enquête ?
                    </p>
                </div>
            </div>
            <div class="space-x-1 bg-gray-50 px-5 py-4 text-right dark:bg-gray-700/50">
                ...
                <button x-on:click="open = false" type="button" wire:click="deleteEtudeEnquete"
