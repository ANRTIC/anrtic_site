<div class="flex flex-col overflow-hidden rounded-lg bg-white shadow-xs dark:bg-gray-800 dark:text-gray-100"
    ...
    <div
        ...
        <div>
            ...
            <h2 class="text-2xl font-bold">Tous les chiffres du secteur</h2>
        </div>
        <div
            class="flex items-center justify-center gap-2 rounded-sm px-2 py-3 sm:justify-end sm:bg-transparent sm:px-0">
            <a href="{{ route('backoffice.chiffres-secteur.ajouter') }}"
                ...
                <span>Ajouter un chiffre du secteur</span>
            </a>
        </div>
    </div>
                ...
                <tbody>
                    @forelse ($chiffres as $chiffre)
                        <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                            ...
                            <td class="p-3">
                                <p class="font-medium">{{ $chiffre->label }}</p>
                            </td>
                            <td class="p-3">
                                <p class="font-medium">{{ $chiffre->sector }}</p>
                            </td>
                            <td class="p-3">
                                <p class="font-medium">{{ $chiffre->source }}</p>
                            </td>
                            <td class="p-3">
                                @if ($chiffre->is_online)
                                    <div
                            ...
                            <td class="py-3 pl-3 text-right">
                                <div class="inline-flex items-center gap-1">
                                    <a href="{{ route('backoffice.chiffres-secteur.modifier', $chiffre->id) }}"
                                    ...
                                    <button type="button" x-on:click="open = true"
                                        ...
                                        wire:click="selectChiffre({{ $chiffre }})">
                                        Supprimer
                                    </button>
                                </div>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td class="text-red-500 font-medium text-center p-2" colspan="5">
                                Rien à afficher
                            </td>
                        </tr>
                    @endforelse
    ...
    <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="flex grow gap-5 px-5 py-7">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Êtes-vous sûr de vouloir supprimer ce chiffre ?
                    </p>
                </div>
            </div>
            <div class="space-x-1 bg-gray-50 px-5 py-4 text-right dark:bg-gray-700/50">
                ...
                <button x-on:click="open = false" type="button" wire:click="deleteChiffre"
