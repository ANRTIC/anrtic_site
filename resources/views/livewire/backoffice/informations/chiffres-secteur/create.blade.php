<div class="flex flex-col overflow-hidden rounded-lg bg-white shadow-xs dark:bg-gray-800 dark:text-gray-100">
        ...
        <div>
            <nav class="text-sm font-medium dark:text-gray-100">
                <ol class="flex items-center justify-center sm:justify-start">
                    ...
                    <li>Chiffres du secteur</li>
                </ol>
            </nav>
            <h2 class="text-2xl font-bold">Ajouter un nouveau chiffre du secteur</h2>
        </div>
    </div>
    ...
    <div class="flex flex-col mt-4 overflow-hidden rounded-lg bg-white shadow-xs dark:bg-gray-800 dark:text-gray-100">
        <div class="grow p-5 md:flex md:gap-5">
            <form enctype="multipart/form-data" wire class="space-y-6 w-full" wire:submit.prevent="save">
                <div class="space-y-1">
                    <label class="inline-block font-medium">Icône</label>
                    <div class="space-y-4 sm:flex sm:items-center sm:gap-4 sm:space-y-0">
                        <input type="file" name='icon' wire:model='icon'
                ...
                <div class="space-y-1">
                    <label class="inline-block font-medium">Libellé</label>
                    <input type="text" wire:model='label' placeholder="Saisir le libellé"
                ...
                <div class="space-y-1">
                    <label class="inline-block font-medium">Secteur</label>
                    <input type="text" wire:model='sector' placeholder="Saisir le secteur"
                        class="block w-full rounded-lg border border-gray-200 px-3 py-2 leading-6 placeholder-gray-500 focus:border-green-500 focus:ring-3 focus:ring-green-500/50 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-green-500" />
                    <p class="text-sm text-red-600 dark:text-red-400">
                        @error('sector')
                            {{ $message }}
                ...
                <div class="space-y-1">
                    <label class="inline-block font-medium">Source</label>
                    <input type="text" wire:model='source' placeholder="Saisir la source"
                        class="block w-full rounded-lg border border-gray-200 px-3 py-2 leading-6 placeholder-gray-500 focus:border-green-500 focus:ring-3 focus:ring-green-500/50 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-green-500" />
                    <p class="text-sm text-red-600 dark:text-red-400">
                        @error('source')
                            {{ $message }}
                ...
                <div class="space-y-1">
                    <label class="group relative inline-flex items-center gap-3">
                        ...
                        ></span>
                        <span class="font-medium">Voulez-vous publier ce chiffre ?</span>
                      </label>
                </div>
                <button type="submit"
