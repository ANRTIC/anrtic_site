                ...
                <tbody>
                    @forelse ($rapports as $rapport)
                        <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                            <td class="p-3">
                                <p class="font-medium">{{ $rapport->title }}</p>
                            </td>
                            <td class="p-3">
                                <p class="font-medium">{{ $rapport->short_description }}</p>
                            </td>
                            <td class="p-3">
                                <p class="font-medium">{{ $rapport->publication_date->format("d M Y") }}</p>
                            </td>
                            <td class="p-3">
                                <p class="font-medium">{{ $rapport->categorie?->name }}</p>
                            </td>
                            <td class="p-3">
                                @if ($rapport->is_online)
                                    <div
                            ...
                            <td class="py-3 pl-3 text-right">
                                <div class="inline-flex items-center gap-1">
                                    <a href="{{ route('backoffice.rapports.edit', $rapport->id) }}"
                                    ...
                                    <button type="button" x-on:click="open = true"
                                        ...
                                        wire:click="selectRapport({{ $rapport }})">
                                        Supprimer
                                    </button>
                                </div>
                            </td>
    ...
    <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="space-x-1 bg-gray-50 px-5 py-4 text-right dark:bg-gray-700/50">
                ...
                <button x-on:click="open = false" type="button" wire:click="deleteRapport"
