        ...
        <div>
            <nav class="text-sm font-medium dark:text-gray-100">
                <ol class="flex items-center justify-center sm:justify-start">
                    ...
                    <li>Administrateurs web</li>
                </ol>
            </nav>
            <h2 class="text-2xl font-bold">Tous les administrateurs web</h2>
        </div>
        <div
            class="flex items-center justify-center gap-2 rounded-sm px-2 py-3 sm:justify-end sm:bg-transparent sm:px-0">
            <a href="{{ route('backoffice.webmasters.ajouter') }}"
                ...
                <span>Ajouter un administrateur web</span>
            </a>
        </div>
    </div>
                ...
                <table class="min-w-full align-middle text-sm whitespace-nowrap">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="group bg-gray-100/75 px-3 py-4 text-right font-semibold text-gray-900 dark:bg-gray-700/25 dark:text-gray-50">
                                Actions
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        @forelse ($users as $user)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                                ...
                                <td class="p-3">
                                    <p class="font-medium">
                                        <span class="uppercase">{{ $user->last_name }} </span>
                                        {{ $user->first_name }}
                                    </p>
                                </td>
                                <td class="p-3">
