                    ...
                    <tbody>
                        @forelse ($lois as $loi)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                                <td class="p-3">
                                    <p class="font-medium">#{{ $loi->reference }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $loi->description }}</p>
                                </td>
                                <td class="p-3">
                                    @if ($loi->is_online)
                                        <div
                                ...
                                <td class="p-3">
                                    <p class="font-medium">{{ $loi->published_at->format('d M Y') }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $loi->adopted_at->format('d M Y') }}</p>
                                </td>
                                <td class="p-3">
                                ...
                                <td class="py-3 pl-3 text-right">
                                    <div class="inline-flex items-center gap-1">
                                        <a href="{{ route('backoffice.lois.modifier', $loi->id) }}"
    ...
    <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="space-x-1 bg-gray-50 px-5 py-4 text-right dark:bg-gray-700/50">
                ...
                <button x-on:click="open = false" type="button" wire:click="deleteLoi"
