        ...
        <div>
            <nav class="text-sm font-medium dark:text-gray-100">
                <ol class="flex items-center justify-center sm:justify-start">
                    ...
                    <li>Avis & décisions</li>
                </ol>
            </nav>
            <h2 class="text-2xl font-bold">Modifier un avis/décision</h2>
        </div>
    </div>
            ...
            <form enctype="multipart/form-data" class="space-y-6 w-full" wire:submit='save'>
                ...
                <div class="space-y-1">
                    ...
                    <div class="space-y-4 sm:flex sm:items-center sm:gap-4 sm:space-y-0">
                        <input type="file" wire:model='newDocument' class="block w-full text-sm text-gray-500 file:mr-4 file:rounded-sm file:border-0 file:bg-green-50 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-green-700 hover:file:bg-green-100 dark:text-gray-400 dark:file:bg-green-200 dark:file:text-green-800 dark:hover:file:bg-green-300" />
                        <p class="text-sm text-red-600 dark:text-red-400">
                            @error('newDocument') {{ $message }} @enderror
                        </p>
                    </div>
                </div>
                <div class="space-y-1">
                ...
                <div class="space-y-1">
                    <label class="group relative inline-flex items-center gap-3">
                        ...
                        ></span>
                        <span class="font-medium">Voulez-vous publier cet avis/décision ?</span>
                      </label>
                </div>
                <button type="submit"
