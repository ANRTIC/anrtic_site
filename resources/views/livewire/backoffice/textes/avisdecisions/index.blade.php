        ...
        <div
            ...
            <div class="min-w-full overflow-x-auto rounded-sm">
                ...
                <table class="min-w-full align-middle text-sm whitespace-nowrap">
                    ...
                    <tbody>
                        @forelse ($avisdecisions as $avisdecision)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                                ...
                                <td class="p-3">
                                    <p class="font-medium">{{ $avisdecision->published_at->format('d M Y') }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $avisdecision->adopted_at->format('d M Y') }}</p>
                                </td>
                                <td class="p-3">
                                    <a href="{{ Storage::url($avisdecision->document) }}" target="_blank"
                                ...
                                <td class="py-3 pl-3 text-right">
                                    <div class="inline-flex items-center gap-1">
                                        <a href="{{ route('backoffice.avis-decisions.modifier', $avisdecision->id) }}"
                                        ...
                                        <button type="button" x-on:click="open = true"
                                            ...
                                            wire:click="selectAvisDecision({{ $avisdecision }})">
                                            Supprimer
                                        </button>
                                    </div>
                                </td>
    ...
    <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="flex grow gap-5 px-5 py-7">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Êtes-vous sûr de vouloir supprimer cet avis/décision ?
                    </p>
                </div>
            </div>
            <div class="space-x-1 bg-gray-50 px-5 py-4 text-right dark:bg-gray-700/50">
                ...
                <button x-on:click="open = false" type="button" wire:click="deleteAvisDecision"
