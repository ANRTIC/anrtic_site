    ...
    <div class="flex flex-col gap-3 bg-gray-50 px-5 py-4 text-center sm:flex-row sm:items-center sm:justify-between sm:gap-0 sm:text-left dark:bg-gray-700/50">
        ...
        <div
            ...
            <a href="{{ route('backoffice.notes_service.ajouter') }}"
                ...
                <span>Ajouter une note de service</span>
            </a>
        </div>
    </div>
        ...
        <div
            ...
            <div class="min-w-full overflow-x-auto rounded-sm">
                ...
                <table class="min-w-full align-middle text-sm whitespace-nowrap">
                    ...
                    <tbody>
                        @forelse ($notesservices as $noteservice)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                                <td class="p-3">
                                    <p class="font-medium">#{{ $noteservice->reference }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $noteservice->description }}</p>
                                </td>
                                <td class="p-3">
                                    @if ($noteservice->is_online)
                                        <div
                                ...
                                <td class="p-3">
                                    <p class="font-medium">{{ $noteservice->published_at->format('d M Y') }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $noteservice->adopted_at->format('d M Y') }}</p>
                                </td>
                                <td class="p-3">
                                    <a href="{{ Storage::url($noteservice->document) }}" target="_blank"
                                        class="inline-flex items-center justify-center gap-2 rounded-lg border border-green-200 bg-green-100 px-2 py-1 text-sm leading-5 font-semibold text-green-800 hover:border-green-300 hover:text-green-900 hover:shadow-xs focus:ring-3 focus:ring-green-300/25 active:border-green-200 active:shadow-none dark:border-green-200 dark:bg-green-200 dark:hover:border-green-300 dark:hover:bg-green-300 dark:focus:ring-green-500/50 dark:active:border-green-200 dark:active:bg-green-200">
                                        <svg class=" inline-block size-5 opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                            <path
                                ...
                                <td class="py-3 pl-3 text-right">
                                    <div class="inline-flex items-center gap-1">
                                        <a href="{{ route('backoffice.notes_service.modifier', $noteservice->id) }}"
                                        ...
                                        <button type="button" x-on:click="open = true"
                                            ...
                                            wire:click="selectNoteService({{ $noteservice }})">
                                            Supprimer
                                        </button>
                                    </div>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td class="text-red-500 font-medium text-center p-2" colspan="7">
                                    Rien à afficher
                                </td>
                            </tr>
                        @endforelse
    ...
    <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="flex grow gap-5 px-5 py-7">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Êtes-vous sûr de vouloir supprimer cette note de service ?
                    </p>
                </div>
            </div>
            <div class="space-x-1 bg-gray-50 px-5 py-4 text-right dark:bg-gray-700/50">
                ...
                <button x-on:click="open = false" type="button" wire:click="deleteNoteService"
