                    ...
                    <tbody>
                        @forelse ($decrets as $decret)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                                <td class="p-3">
                                    <p class="font-medium">#{{ $decret->reference }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $decret->description }}</p>
                                </td>
                                <td class="p-3">
                                    @if ($decret->is_online)
                                        <div
                                ...
                                <td class="p-3">
                                    <p class="font-medium">{{ $decret->published_at->format('d M Y') }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $decret->adopted_at->format('d M Y') }}</p>
                                </td>
                                <td class="p-3">
                                    <a href="{{ Storage::url($decret->document) }}" target="_blank"
                                ...
                                <td class="py-3 pl-3 text-right">
                                    <div class="inline-flex items-center gap-1">
                                        <a href="{{ route('backoffice.decrets.modifier', $decret->id) }}"
                                        ...
                                        <button type="button" x-on:click="open = true"
                                            ...
                                            wire:click="selectDecret({{ $decret }})">
                                            Supprimer
                                        </button>
                                    </div>
                                </td>
    ...
    <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="flex grow gap-5 px-5 py-7">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Êtes-vous sûr de vouloir supprimer ce décret ?
                    </p>
                </div>
            </div>
            <div class="space-x-1 bg-gray-50 px-5 py-4 text-right dark:bg-gray-700/50">
                ...
                <button x-on:click="open = false" type="button" wire:click="deleteDecret"
