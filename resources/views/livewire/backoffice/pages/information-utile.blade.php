    ...
    <div class="flex flex-col overflow-hidden rounded-lg bg-white shadow-xs dark:bg-gray-800 dark:text-gray-100"
                    ...
                    <ol class="flex items-center justify-center sm:justify-start">
                        <li>
                            <a href="javascript:void(0)"
                                class="text-green-600 hover:text-green-400 dark:text-green-400 dark:hover:text-green-300">
                                Pages
                            </a>
                        </li>
                        ...
                        <li>Information utile</li>
                    </ol>
                </nav>
                <h2 class="text-2xl font-bold">Information utile</h2>
            </div>
        </div>
        ...
        <div class="flex flex-col mt-4 overflow-hidden rounded-lg bg-white shadow-xs dark:bg-gray-800 dark:text-gray-100">
            <div class="grow p-5 md:flex md:gap-5">
                <form action="{{ route("backoffice.informationUtile") }}" method="POST" class="space-y-6 w-full">
                    @csrf
                    <div class="space-y-1">
                        <label class="inline-block font-medium">Titre</label>
                        <input type="text" name="title" value="{{ old("title", $page->title ?? "") }}" placeholder="Saisir le titre"
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="content" class="block w-full rounded-lg border border-gray-200 px-3 py-2 leading-6 placeholder-gray-500 focus:border-green-500 focus:ring-3 focus:ring-green-500/50 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-green-500"
                            id="froala-editor">
