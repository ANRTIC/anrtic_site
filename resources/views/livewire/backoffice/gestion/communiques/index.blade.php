    ...
    <div
        ...
        <div
            ...
            <a href="{{ route("backoffice.communiques.ajouter") }}"
                ...
                <span>Ajouter un communiqué</span>
            </a>
        </div>
    </div>
        ...
        @forelse ($communiques as $communique)
            <div class="flex flex-col rounded-lg bg-white shadow-xs dark:bg-gray-800 dark:text-gray-100">
                ...
                <div class="flex grow flex-col gap-5 p-5">
                    <!-- Placeholder -->
                    <a href="{{ route('backoffice.communiques.modifier', $communique->id) }}"
                        ...
                        <img src="{{ $communique->thumbnail() }}" alt="{{ $communique->short_description }}"
                    ...
                    <div>
                        <a href="{{ route('backoffice.communiques.modifier', $communique->id) }}"
                            ...
                            <h3 class="font-bold">
                                {{ Str::limit($communique->short_description, 40) }} 

                                @if ($communique->is_online)
                            ...
                            <p class="mt-1 text-sm/relaxed text-gray-600 dark:text-gray-400">
                                {!! Str::limit($communique->content, 130) !!}
                            </p>
                        </a>
                    </div>
                    <!-- END Content -->
                    ...
                    <div class="flex gap-2">
                        ...
                        <button type="button" x-on:click="open = true" wire:click="selectCommunique({{ $communique }})"
        ...
        @empty
            <div class="relative px-6 w-full py-20 md:py-40 dark:border-gray-700">
                <div class="relative flex flex-col gap-5 text-center">
                    ...
                    <div class="mx-auto">
                        <h3 class="mb-2 text-2xl font-bold">Rien à afficher</h3>
                        <p class="text-sm/relaxed font-medium text-gray-600 dark:text-gray-400">
                            Vos communiqués apparaiteront ici!
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="flex grow gap-5 px-5 py-7">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Êtes-vous sûr de vouloir supprimer ce communiqué ?
                    </p>
                </div>
            </div>
            <div class="space-x-1 bg-gray-50 px-5 py-4 text-right dark:bg-gray-700/50">
                ...
                <button x-on:click="open = false" type="button" wire:click="deleteCommunique"
