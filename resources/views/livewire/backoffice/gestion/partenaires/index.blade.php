                    ...
                    <tbody>
                        @forelse ($partenaires as $partenaire)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                                ...
                                <td class="p-3">
                                    <p class="font-medium">{{ $partenaire->name }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $partenaire->email }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $partenaire->phone }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $partenaire->website }}</p>
                                </td>
                                <td class="p-3">
                                ...
                                <td class="py-3 pl-3 text-right">
                                    <div class="inline-flex items-center gap-1">
                                        <a href="{{ route('backoffice.partenaires.modifier', $partenaire->id) }}"
                                        ...
                                        <button type="button"
                                            ...
                                            wire:click="selectPartenaire({{ $partenaire }})">
                                            Supprimer
                                        </button>
                                    </div>
                                </td>
