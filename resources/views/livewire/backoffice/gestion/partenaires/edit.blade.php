<div class="flex flex-col overflow-hidden rounded-lg bg-white shadow-xs dark:bg-gray-800 dark:text-gray-100">
    ...
    <div
        ...
        <div>
            ...
            <h2 class="text-2xl font-bold">Modifier un partenaire</h2>
        </div>
    </div>
    ...
    <div class="flex flex-col mt-4 overflow-hidden rounded-lg bg-white shadow-xs dark:bg-gray-800 dark:text-gray-100">
        <div class="grow p-5 md:flex md:gap-5">
            <form enctype="multipart/form-data" class="space-y-6 w-full" wire:submit='save'>
                <div class="space-y-1">
                    <label class="inline-block font-medium">Logo</label>
                    <div class="space-y-4 sm:flex sm:items-center sm:gap-4 sm:space-y-0">
                        <input type="file" wire:model='newLogo' id="filepond-input" class="block w-full text-sm text-gray-500 file:mr-4 file:rounded-sm file:border-0 file:bg-green-50 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-green-700 hover:file:bg-green-100 dark:text-gray-400 dark:file:bg-green-200 dark:file:text-green-800 dark:hover:file:bg-green-300" />
                        <p class="text-sm text-red-600 dark:text-red-400">
                            @error('newLogo') {{ $message }} @enderror
                        </p>
                    </div>
                </div>
                <div class="space-y-1">
                    <label class="inline-block font-medium">Nom</label>
                ...
                <div class="space-y-1">
                    <label class="inline-block font-medium">Email</label>
                    <input type="text" wire:model='email' placeholder="Saisir l'adresse email"
                        class="block w-full rounded-lg border border-gray-200 px-3 py-2 leading-6 placeholder-gray-500 focus:border-green-500 focus:ring-3 focus:ring-green-500/50 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-green-500" />
                    <p class="text-sm text-red-600 dark:text-red-400">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" wire:model='phone' placeholder="Saisir le numéro de téléphone"
                        class="block w-full rounded-lg border border-gray-200 px-3 py-2 leading-6 placeholder-gray-500 focus:border-green-500 focus:ring-3 focus:ring-green-500/50 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-green-500" />
                    <p class="text-sm text-red-600 dark:text-red-400">
                ...
                <div class="space-y-1">
                    <label class="inline-block font-medium">Site web</label>
                    <input type="text" wire:model='website' placeholder="Saisir l'adresse du site web"
                        class="block w-full rounded-lg border border-gray-200 px-3 py-2 leading-6 placeholder-gray-500 focus:border-green-500 focus:ring-3 focus:ring-green-500/50 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-green-500" />
                    <p class="text-sm text-red-600 dark:text-red-400">
                ...
                <div class="space-y-1">
                    <label class="group relative inline-flex items-center gap-3">
                        <input type="checkbox" class="peer sr-only" wire:model='is_active' />
                        <span
                        ...
                        ></span>
                        <span class="font-medium">Voulez-vous publier ce partenaire ?</span>
                      </label>
                </div>
                <button type="submit"
