                    ...
                    <tbody>
                        @forelse ($agents as $agent)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                                <td class="p-3">
                                    @if ($agent->photo)
                                        <img src="{{ $agent->photoURL() }}"
                                            alt="{{ $agent->last_name . ' ' . $agent->first_name }}"
                                ...
                                <td class="p-3">
                                    <p class="font-medium">{{ $agent->last_name }}</p>
                                </td>
                                <td class="p-3">
                                    <p class="font-medium">{{ $agent->first_name }}</p>
                                </td>
                                <td class="p-3">
                                    <div class="flex items-center gap-2">
                                        <p class="font-medium">{{ $agent->email }}</p>
                                        @if ($agent->isEmailVerified())
                                            <div class="inline-flex items-center gap-1 rounded-sm bg-green-200 px-2 py-1 text-xs leading-4 font-semibold text-green-700">
                                                <svg class="inline-block size-4 opacity-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="currentColor">
                                                    <path
                                        ...
                                        @else
                                            <div class="inline-flex items-center gap-1 rounded-sm bg-red-200 px-2 py-1 text-xs leading-4 font-semibold text-red-700">
                                                <svg class="inline-block size-4 opacity-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="currentColor">
                                                    <path
                                ...
                                <td class="p-3">
                                    <p class="font-medium">{{ $agent->lastLogin() }}</p>
                                </td>
                                <td class="p-3">
                                    @if (!$agent->is_blocked)
                                        <div class="inline-flex items-center gap-1 rounded-sm bg-green-200 px-2 py-1 text-xs leading-4 font-semibold text-green-700">
                                ...
                                <td class="py-3 pl-3 text-right">
                                    <div class="inline-flex items-center gap-1">
                                        <a href="{{ route("backoffice.homologation.agents.modifier", $agent->id) }}"
