...
<body>
    ...
    <div id="page-container"
        ...
        <main id="page-content" class="flex max-w-full flex-auto flex-col">
            <div
                class="relative mx-auto flex min-h-dvh w-full max-w-10xl items-center justify-center overflow-hidden bg-white p-4 lg:p-8 dark:bg-gray-800">
                <!-- Maintenance Section -->
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div class="p-12 text-green-600 lg:p-20">
                            <svg class="mx-auto w-48 lg:w-full" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path fill="#2f2e41"
                                    d="m409.01 524.72-30.446-.002v-.385a11.851 11.851 0 0 1 11.85-11.85h.001l5.562-4.22 10.376 4.22h2.658Z" />
                                <path fill="#ffb6b6"
                                    d="m537.03 460.1-6.395 7.558-32.199-21.068 9.438-11.156L537.03 460.1z" />
                                <path fill="#2f2e41"
                                    d="m545.141 466.504-19.665 23.245-.293-.248a11.851 11.851 0 0 1-1.395-16.702l.371-6.971 9.924-5.197 1.716-2.03Z" />
                                ...
                                <path fill="#2f2e41"
                                    d="m457 233.491-53.079 6.158L383 275.491l-3 12 1.358 8.25-3.358 5.75 2 11-8 87 22 98h20.5l-6.5-91 17-78 15 76 69.37 60.412 16.158-23.164L472 396.491l-5-16 6.737-13.528L479 277.491l-22-44z" />
