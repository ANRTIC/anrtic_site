...
class CommuniqueController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData["thumbnail"] = Storage::put("/media/communiques", $request->file("thumbnail"));
        Communique::create($validatedData);

        return redirect()->route("backoffice.communiques");
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("thumbnail")) {
            Storage::delete($communique->thumbnail);
            $validatedData["thumbnail"] = Storage::put("/media/communiques", $request->file("thumbnail"));
        }
        $communique->update($validatedData);
        return redirect()->route("backoffice.communiques");
