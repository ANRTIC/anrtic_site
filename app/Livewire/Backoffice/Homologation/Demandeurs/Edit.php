...
class Edit extends Component
{
    ...
    public $r_email;
    public $r_telephone;
    public bool $has_representative;

    public function mount($id)
    {
        $this->demandeur = Demandeur::findOrFail($id);
        $this->representant = $this->demandeur->representant()->exists() ? $this->demandeur->representant : null;
        $this->d_nom_complet = $this->demandeur->nom_complet;
        $this->d_adresse = $this->demandeur->adresse;
        $this->d_email = $this->demandeur->email;
        $this->d_telephone = $this->demandeur->telephone;
        
        $this->r_nom_complet = $this->demandeur->representant()->exists() ? $this->demandeur->representant->nom_complet : null;
        $this->r_adresse = $this->demandeur->representant()->exists() ? $this->demandeur->representant->adresse : null;
        $this->r_email = $this->demandeur->representant()->exists() ? $this->demandeur->representant->email : null;
        $this->r_telephone = $this->demandeur->representant()->exists() ? $this->demandeur->representant->telephone : null;
        $this->has_representative = $this->demandeur->representant()->exists();
    }
    ...
    public function save()
    {
        ...
        if (!$this->has_representative && $this->demandeur->representant()->exists()) {
            $this->demandeur->update([
    ...
    {
        return view('livewire.backoffice.homologation.demandeurs.edit')
