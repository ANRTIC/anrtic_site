...
Route::middleware(["auth:sanctum", "verified", "checkBlocked"])->group(function() {
    ...
    Route::group(["as" => "backoffice.", "prefix" => "backoffice"], function () {
        ...
        // SUPER_ADMIN
        Volt::route("webmasters", "backoffice.superadmin.utilisateurs.index")->name("webmasters");
        Volt::route("webmasters/ajouter", "backoffice.superadmin.utilisateurs.create")->name("webmasters.ajouter");
        Volt::route("webmasters/modifier/{id}", "backoffice.superadmin.utilisateurs.edit")->name("webmasters.modifier");
    });
